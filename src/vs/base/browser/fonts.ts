 ...
 */
export const DEFAULT_FONT_FAMILY = isWindows ? '"Geist", "Segoe WPC", "Segoe UI", sans-serif' : isMacintosh ? '"Geist", -apple-system, BlinkMacSystemFont, sans-serif' : '"Geist", system-ui, "Ubuntu", "Droid Sans", sans-serif';
