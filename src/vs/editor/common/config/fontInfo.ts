 ...
 * @internal
 */
export const DEFAULT_WINDOWS_FONT_FAMILY = '\'Geist Mono\', Consolas, \'Courier New\', monospace';
/**
 * @internal
 */
export const DEFAULT_MAC_FONT_FAMILY = '\'Geist Mono\', Menlo, Monaco, \'Courier New\', monospace';
/**
 * @internal
 */
export const DEFAULT_LINUX_FONT_FAMILY = '\'Geist Mono\', \'Droid Sans Mono\', monospace';
/**
 * @internal
 */
