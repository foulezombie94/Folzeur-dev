		...
		super({
			...
			menu: [{
				...
				when: ContextKeyExpr.and(
					ContextKeyExpr.false(), // Antigravity: Hide Agent mode picker
					ContextKeyExpr.or(IsActiveSessionCopilotChatCLI, IsActiveSessionCopilotChatLocal, IsActiveSessionLocal)
				),
			}],
		});
	}
