...
import '../workbench/services/agent/electron-browser/agentServiceImpl.js';
...
// Appica authentication
import '../workbench/contrib/preferences/electron-browser/settingsHomeSupabaseAuth.contribution.js';
...
// The Agents window uses the in-process native Folzeur agent registered by
// chat.shared.contribution. Do not register the local Copilot CLI Agent Host
// provider here because it has a different runtime, tool set, and system prompt.
...
export { main, type IDesktopMain } from './electron-browser/sessions.main.js';
