...
export class LocalAgentHostServiceClient extends Disposable implements IAgentHostService {
	...
	private async _connect(): Promise<void> {
		...
		this._logService.debug(`${LOG_PREFIX} Acquiring MessagePort to agent host...`);
		...
		this._logService.debug(`${LOG_PREFIX} MessagePort acquired, creating client...`);
		...
		this._logService.debug(`${LOG_PREFIX} Protocol connection established; clientId=${protocolClient.clientId}`);
