...
registerAction2(class OpenAgentSessionsWelcomeAction extends Action2 {
	...
	async run(accessor: ServicesAccessor): Promise<void> {
		...
		// Always ensure left bar (sidebar) is OPEN and right bar (auxiliary bar) is CLOSED on agent open
...
class AgentSessionsWelcomeRunnerContribution extends Disposable implements IWorkbenchContribution {
	...
	private async run(): Promise<void> {
		...
		// Always ensure left bar (sidebar) is OPEN and right bar (auxiliary bar) is CLOSED on agent startup
