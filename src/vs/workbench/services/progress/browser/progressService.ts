...
export class ProgressService extends Disposable implements IProgressService {
	...
	private get paneCompositeService(): IPaneCompositePartService {
		if (!this._paneCompositeService) {
			this._paneCompositeService = this.instantiationService.invokeFunction(accessor => accessor.get(IPaneCompositePartService));
		}
		return this._paneCompositeService;
	}
